...
type migihidari struct {
	migi   int `json:"right,omitempty"`
	hidari int `json:"left,omitempty"`
}
...
func addHandler(c echo.Context) error {
	...
	jsonAnswer := data.migi + data.hidari

	return c.JSON(http.StatusOK, jsonAnswer)
}
